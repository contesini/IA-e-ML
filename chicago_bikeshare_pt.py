...
def printLinesAndColumns(start, end, columns):
    """ 
      Função que imprime a quantidade de linhas definidas entre 
      dois as variaveis start e end e as colunas informadas em columns 
      Argumentos:
          start: primeiro numero do intervalo
          end: ultimo numero do intervalo
          columns: colunas
      Retorna:
          sem retorno apenas print
    """
    lineToprint = ""
    for line in data_list[start:end]:
        for column in columns:
            lineToprint += line[column] + "\t"
        print(lineToprint + "\n")
        lineToprint = ""
...
printLinesAndColumns(1, 20,  list(range(0, 8)))
...
def column_to_list(data, index):
    """ 
      Função que retorna uma lista de apenas uma 
      coluna de uma lista com varias colunas
      Argumentos:
          data: lista
          end: index da coluna
      Retorna:
...
def count_gender(data_list):
    """ 
      Função que retorna uma lista com dois itens que representam
      as quantidades de male e female na lista
      Argumentos:
          data: lista
      Retorna:
          retorna uma lista
...
def most_popular_gender(data_list):
    """ 
      Função que retorna o genero com maior prevalencia
      em uma lista
      Argumentos:
          data: lista
      Retorna:
...
answer = "Por que existem linhas em data_list sem gênero"
...
def getMediasViagem(tempoViagens):
   ...
   count = 0
   tempoViagensToIn = []
   for tempoViagem in tempoViagens:
       tempo = float(tempoViagem)
       if tempo > max_trip:
           max_trip = tempo
       tempoTotal += tempo
       count += 1
       tempoViagensToIn.append(tempo)
   min_trip = max_trip
...
min_trip, max_trip, mean_trip, median_trip = getMediasViagem(
    trip_duration_list)
